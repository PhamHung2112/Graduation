...
const ProductList: FC = () => {
  ...
  return (
    <Container maxWidth="xl">
      <Widget title="Sản phẩm mới" buttonTitle="xem thêm" onShowMore={showMoreNewProduct}>
        <ProductItem productList={newProductData} />
      </Widget>
      <Widget title="Sản phẩm giảm giá" buttonTitle="xem thêm" onShowMore={showMoreSaleProduct}>
